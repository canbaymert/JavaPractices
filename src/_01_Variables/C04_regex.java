...
public class C04_regex {
    public static void main(String[] args) {
        ...
        System.out.println("aaddta".matches("[abc]+")); // false, string should not contain d or t
        ...
        System.out.println("99530389490".matches("[789][0-9]{9}")); // false, sting should not contain more or less than 10 characters
    }
}
