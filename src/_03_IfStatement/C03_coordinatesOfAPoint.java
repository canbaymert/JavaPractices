...
public class C03_coordinatesOfAPoint {
    public static void main(String[] args) {
        ...
        if (x == 0 && y == 0) System.out.println("Point is located on Origin");
        else if (x == 0) System.out.println("Point is located on Y-Axis");
        else if (y == 0) System.out.println("Point is located on X-Axis");
        else if (x > 0 && y > 0) System.out.println("Point is located on Quadrant 1");
